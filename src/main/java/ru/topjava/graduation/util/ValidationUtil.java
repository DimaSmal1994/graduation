...
import ru.topjava.graduation.util.exception.UserVoteIncorrectDateException;
import ru.topjava.graduation.util.exception.UserVoteTooLateException;
...
public class ValidationUtil {
    ...
    public static <T> T checkIsNotFoundWithId(T object, int id) {
